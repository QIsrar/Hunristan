...
export default function LandingPage() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      supabase.from("hackathons").select("id", { count: "exact", head: true }).eq("is_approved", true),
    ]).then(([{ count: participants }, { count: problems }, { count: hackathons }]) => {
      setStats([
        { value: participants ? `${participants.toLocaleString()}+` : "2,400+", label: "Participants" },
        { value: problems ? `${problems}+` : "180+", label: "Problems" },
        { value: hackathons ? String(hackathons) : "48", label: "Hackathons" },
        { value: "15+", label: "Languages" },
      ]);
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              ...
              <p className="text-muted text-sm mt-1">© 2026 Smart Hunristan. All rights reserved.</p>
            </div>
