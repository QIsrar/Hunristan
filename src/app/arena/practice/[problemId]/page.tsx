...
export default function PracticeArenaPage() {
  ...
  useEffect(() => {
    async function load() {
      ...
      // Fall back to built-in sample problems if not in DB
      const resolvedProblem = prob ?? SAMPLE_PROBLEMS[problemId as keyof typeof SAMPLE_PROBLEMS] ?? null;
      if (!resolvedProblem) { toast.error("Problem not found"); return router.push("/practice"); }
      setProblem(resolvedProblem as any);
      setSubmissions(subs || []);
...
// Built-in sample problems — used as fallback when IDs not in Supabase DB
const SAMPLE_PROBLEMS = {
  p1: {
    id: "p1", hackathon_id: "h1", title: "Two Sum", slug: "two-sum",
    difficulty: "easy" as const, time_limit_ms: 2000, memory_limit_mb: 256, points: 100, order_index: 0,
  ...
  p2: {
    id: "p2", hackathon_id: "h1", title: "Maximum Subarray", slug: "max-subarray",
    difficulty: "easy" as const, time_limit_ms: 2000, memory_limit_mb: 256, points: 100, order_index: 1,
  ...
  p3: {
    id: "p3", hackathon_id: "h2", title: "Longest Palindromic Substring", slug: "longest-palindrome",
    difficulty: "medium" as const, time_limit_ms: 2000, memory_limit_mb: 256, points: 200, order_index: 0,
  ...
  p4: {
    id: "p4", hackathon_id: "h2", title: "Valid Parentheses", slug: "valid-parentheses",
    difficulty: "medium" as const, time_limit_ms: 2000, memory_limit_mb: 256, points: 200, order_index: 1,
  ...
  p5: {
    id: "p5", hackathon_id: "h3", title: "N-Queens Count", slug: "n-queens",
    difficulty: "hard" as const, time_limit_ms: 5000, memory_limit_mb: 512, points: 400, order_index: 0,
  ...
  p6: {
    id: "p6", hackathon_id: "h3", title: "Shortest Path in Grid", slug: "grid-shortest-path",
    difficulty: "hard" as const, time_limit_ms: 5000, memory_limit_mb: 512, points: 500, order_index: 1,
    description: "Given an `m x n` binary grid where `0` represents open cell and `1` represents an obstacle, find the shortest path from top-left (0,0) to bottom-right (m-1,n-1). You can move in 4 directions.\n\nReturn -1 if no path exists.",
    input_format: "Line 1: m n (grid dimensions)\nNext m lines: n space-separated integers (0 or 1)",
    constraints: "1 ≤ m, n ≤ 100\nGrid values are 0 or 1",
    sample_input: "3 3\n0 0 0\n1 1 0\n0 0 0",
    sample_output: "4",
    explanation: "Shortest path: (0,0)→(0,1)→(0,2)→(1,2)→(2,2), length 4.",
  },
};